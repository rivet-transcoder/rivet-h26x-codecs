...
size down to 8x8, and the CTB is 32x32 at every picture size, partial
along the right and bottom edges; whole 16x16 CTBs remain only at
`max_cu_depth` 0, where they pad less.) The H.265 rows are reached through the quantiser: the same two
